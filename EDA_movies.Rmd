Exploring IMDB Movies Dataset by Iulia Khomenko
========================================================

Dataset URL: https://www.kaggle.com/deepmatrix/imdb-5000-movie-dataset
...
str(movies)
```
The dataset contains 5043 observations and 28 variables.
